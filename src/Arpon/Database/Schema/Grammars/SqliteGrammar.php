...
class SqliteGrammar extends Grammar
{
     ...
     * @var array
     */
    protected $modifiers = ['Nullable', 'Default', 'Increment', 'After', 'First'];
     ...
     * @return array
     */
    public function compileAdd($blueprint, $command)
    {
     ...
     * 
     * Note: SQLite does not support column positioning with AFTER.
     * Columns will be added at the end of the table.
     *
     * @param  \Arpon\Database\Schema\Definitions\ColumnDefinition  $column
     * @return string|null
     */
    protected function modifyAfter($column)
    {
        // SQLite does not support AFTER clause in ALTER TABLE
        return null;
    }
     ...
     * 
     * Note: SQLite does not support column positioning with FIRST.
     * Columns will be added at the end of the table.
     *
     * @param  \Arpon\Database\Schema\Definitions\ColumnDefinition  $column
     * @return string|null
     */
    protected function modifyFirst($column)
    {
        // SQLite does not support FIRST clause in ALTER TABLE
        return null;
    }
}