...
use Arpon\Pagination\Paginator;
use Closure;
...
class Builder
{
    ...
    /**
     * Add a "where column" clause to the query (comparing two columns).
     *
     * @param  string  $first
    ...
    {
        // If the operator is not provided, default to '='
        if (is_null($second)) {
     ...
     * @param  int|null  $page
     * @return \Arpon\Pagination\Paginator
     */
